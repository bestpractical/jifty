...
This class method instantiates a new C<Jifty::Logger> object. This object deals
with loggin for the system.

Takes an optional name for this Jifty's logging "component" - See Log4Perl for some detail about what that is.
...
sub new {
    ...
    my $log_config = Jifty::Util->absolute_path( Jifty->config->framework('LogConfig'));
    if (defined Jifty->config->framework('LogReload')) {
        Log::Log4perl->init_and_watch($log_config, Jifty->config->framework('LogReload'));
