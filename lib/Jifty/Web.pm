...
app-specific C<CurrentUser> object. (This is determined by theC<framework> configuration
varialbe C<CurrentUserClass> and defaults to $AppNameC<::CurrentUser>, a subclass
of L<Jifty::CurrentUser>.  $AppNameC<::CurrentUser> is autogenerated if it doesn't
exist.
