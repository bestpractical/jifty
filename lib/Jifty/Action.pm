...
The L<moniker|Jifty::Glossary/moniker> of the action.  Defaults to an
...
L<arguments|Jifty::Glossary/arguments> of the action.  Defaults to
none.

=item sticky_on_failure

A boolean value that determines if the form fields are
L<sticky|Jifty::Glossary/sticky> when the action fails.  Defaults to
true.

=item sticky_on_success

A boolean value that determines if the form fields are
L<sticky|Jifty::Glossary/sticky> when the action succeeds.  Defaults
to false.
...
L<arguments|Jifty::Glossary/argument> this action takes:
...
these should have the L<constructor|Jifty::Glossary/constructor>
property set.  This is separate from the
L<mandatory|Jifty::Glossary/mandatory> property, which deal with
...
Returns the L<moniker|Jifty::Glossary/moniker> for this action.
...
"L<active|Jifty::Glossary/active>" actions.
...
Turn one of this action's L<arguments|Jifty::Glossary/arguments> into
...
Canonicalizes each of the L<arguments|Jifty::Glossary/arguments> that
...
Canonicalizes the value of an L<argument|Jifty::Glossary/argument>.
...
Given an L<argument|Jifty::Glossary/argument> name, returns the list
