...
JFDI::Manual::AccessControl

=head2 DESCRIPTION


Out of the box JFDI-based applications have an ACL system.  The system 
automatically validates ACLs on JFDI::Record objects by calling the method
...
Out of the box, C<current_user_can> returns 1. When you want to actually check ACLs, you'll need to override C<current_user_can()> in your C<JFDI::Record> subclass.
