...
write your docs, put them in F<docs/>.
...
Open a new file called F<index.html> in your text editor. (Your webserver will
...
Both the easy way and complex way start off about the same.  Open a new file
