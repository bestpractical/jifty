...
package JFDI::Collection;

=head1 NAME

JFDI::Collection - Collection of JFDI::Record objects

=head1 SYNOPSIS

  package Foo::Model::BarCollection
  use base qw/JFDI::Collection/;
...
use base qw/JFDI::Object Jifty::DBI::Collection Class::Accessor/;
use Data::Page;
